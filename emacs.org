...
* Modes I use frequently for programming
** Primary heavy-duty modes
...
(use-package prettier-js
  ...
  (setq prettier-js-args
	`(,(concat "--config " (concat "/home/dev/Projects/usq/usq_api/.prettierrc"))      ; this works if I only have one prettierrc file. Need a better solution
	  "--write"))
  :hook (web-mode js2-mode typescript-mode))
